  ...
  return (
    ...
    flex items-center justify-between z-50'>
        ...
        <div className='flex items-center gap-4'>
            ...
            py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contact <Image src={assets.arrow_icon} alt="Arrow Icon" className='w-3 ' /></a>
                ...
                <button className='block md:hidden ml-3' onClick={openMenu}>
                 ...
                 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500'>
                    ...
                    <div className='absolute right-6 top-6' onClick={closeMenu}>
                        <Image src={assets.close_black} alt="Close Menu Icon" className='w-5 cursor-pointer' />
                    </div>
